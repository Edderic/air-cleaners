...
module screw_with_nut(hex_nut_height=2, screw_head_height=3, threaded_height=10, threaded_radius=1.5, screw_head_radius=3, hex_nut_side_length=3, square_nut_height=2, square_nut_side_length=5, nut_type="hex") {
