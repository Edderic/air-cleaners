    ...
    union() {
      difference() {
        ...
        union() {
          ...
          translate([0, 0, z - edge_1_5_radius]) {
            color([1,0,0]) cube([edge_1_5_radius,y,edge_1_5_radius]);
          }

          // edge from vertex 2 to 6
          translate([0, 0,0]) {
            color([1,0,0]) cube([edge_2_6_radius,y,edge_2_6_radius]);
          }

          // edge from vertex 3 to 7
          translate([x - edge_3_7_radius, 0,0]) {
            color([1,0,0]) cube([edge_3_7_radius,y,edge_3_7_radius]);
          }

          // edge from vertex 4 to 8
          translate([x - edge_4_8_radius, 0, z - edge_4_8_radius]) {
            color([1,0,0]) cube([edge_4_8_radius,y, edge_4_8_radius]);
          }
      ...
      union() {
        ...
        translate([x - edge_4_8_radius, radius_4, z - edge_4_8_radius]) {
          rotate([0,90,0])
            rotate([-90,0,0])
        ...
        translate([radius_6,y - edge_6_7_radius,edge_6_7_radius]) {
          rotate([180,0,0])
            rotate([0,90,0])
...
// smoothed_cube(edge_1_2_radius=5, radius_2=5, radius_1=5, edge_2_3_radius=5, edge_3_4_radius=5, radius_3=5, radius_4=5, edge_4_1_radius=5, radius_5=5, edge_1_5_radius=5, edge_2_6_radius=5, radius_6=5, edge_3_7_radius=5, radius_7=5, edge_4_8_radius=5, radius_8 = 5, edge_5_6_radius=5, edge_7_8_radius=5, edge_8_5_radius=5, edge_6_7_radius=5);
  // smooth edge from vertex 6 to 7
smoothed_cube(edge_4_8_radius=5, radius_4=5);
// smoothed_cube(radius_1=5, radius_2=5, edge_1_2_radius=5, edge_2_3_radius=0, edge_4_1_radius=5, edge_1_5_radius=5, edge_2_6_radius=5, edge_4_8_radius=5, radius_4=0, radius_8=0);
